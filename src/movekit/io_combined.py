...
def io_methods(
	...
	"""
	if parse_csv_fn == True:
		return parse_csv(path_to_file)

	elif parse_excel_fn == True:
		return parse_excel(path_to_file)
	"""
...
# Simply provide the absolute/complete path to where file is-
data = io_methods(path_to_file="/path_to_file/fish-5.xlsx")

"""
data_csv = io_methods(
	parse_csv_fn=True,
	path_to_file="/path_to_file/fish-5.csv"
	)
"""
