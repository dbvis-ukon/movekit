...
def compute_distance_and_direction(data_animal_id_groups):
    ...
    for aid in data_animal_id_groups.keys():
        ...
        distance = {
            'sum_of_distance': distance_metric_sum,
...
#     print("Animal ID: {0} & total metric distance travelled = {1:.2f}".format(
#         aid, distance['sum_of_distance'][aid]))

# print("\nThe maximum distance travelled by each animal id is:")
# for aid in distance['maximum_distance'].keys():
#     print("Animal ID: {0} & total metric distance travelled = {1:.2f}".format(
#         aid, distance['maximum_distance'][aid]))
